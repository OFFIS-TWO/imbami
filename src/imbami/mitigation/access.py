...
#             # Validate parameters
#             validated_params = _validate_parameters(required_params, kwargs, sampler_type)
...
#         case _:
#             raise ValueError(f"Unknown sampler type: '{sampler_type}'. Sampler Type not implemented in Sampler Factory.")
